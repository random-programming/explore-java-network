package benchmark.server.iouring;
...
public class IoUringServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        EventLoopGroup workerGroup = new IOUringEventLoopGroup(threads);
        ...
        try {
            ...
            System.out.println("Server started on port " + port + " with " + threads + " threads (io_uring)");
