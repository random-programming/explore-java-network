...
with open('/ssd/benchmark/reports_v5/analysis_v5.md', 'r') as f:
    md_text = f.read()
...
HTML(string=html_full).write_pdf('/ssd/benchmark/reports_v5/analysis_v5.pdf')
print("Saved: /ssd/benchmark/reports_v5/analysis_v5.pdf")
