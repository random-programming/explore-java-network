...
with open('/ssd/benchmark/docs/methodology_v3.md', 'r') as f:
    md_text = f.read()
...
HTML(string=html_full).write_pdf('/ssd/benchmark/docs/methodology_v3.pdf')
print("Saved: /ssd/benchmark/docs/methodology_v3.pdf")
